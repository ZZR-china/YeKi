...
/***/ (function(module, exports, __webpack_require__) {
	...
	var microdata = JSON.parse(appEle.getAttribute('data-microdata'));
	var mydata = JSON.parse(appEle.getAttribute('data-mydata'));
	mydata.nick += ', then client reRender ';
	
	(0, _reactDom.render)(_react2.default.createElement(_Content2.default, { mydata: mydata, microdata: microdata }), appEle);
